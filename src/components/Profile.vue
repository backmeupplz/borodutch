  ...
  v-row
    v-col(:cols='$vuetify.breakpoint.lgAndUp ? undefined : 12')
      ...
      .user-count-updated
        ...
        Link(url="https://github.com/backmeupplz/borodutch-stats/blob/master/src/helpers/userCount.ts") here
      ...
      .social-block
        ...
        v-btn.social-button-margin(text icon href="https://m.me/borodutch" target="_blank")
          v-icon(:size='20') $facebook
        v-btn.social-button-margin(text icon href="https://linkedin.com/in/nikitakolmogorov" target="_blank")
          v-icon(:size='20') $linkedin
        v-btn.social-button-margin(text icon href="https://github.com/backmeupplz" target="_blank")
          v-icon(:size='20') $github
        v-btn.social-button-margin(text icon href="https://vk.com/borodutch" target="_blank")
          v-icon(:size='20') $vk
        v-btn.social-button-margin(text icon href='mailto:n@borodutch.com' target='_blank')
          v-icon(:size='20') $email
    v-col(:cols='$vuetify.breakpoint.lgAndUp ? undefined : 12').clips-subviews
...
.circle {
  ...
  background: linear-gradient(46.19deg, #f09819 5.66%, #edde5d 94.35%);
  opacity: 0.8;
  border-radius: 50%;
}
.user-count {
