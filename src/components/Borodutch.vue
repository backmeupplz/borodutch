  ...
  v-card
    ...
    v-card-text
      ...
      p
        ...
        a(href="https://github.com/backmeupplz/borodutch" target="_blank") the website
        |  and for 
        a(href="https://github.com/backmeupplz/borodutch-stats" target="_blank") the stats server
        | .
